if (typeof scaffolding == "undefined") {
  ...
  `;
    ...
    height: 20px;
    position: sticky;
    background-color: rgb(0 195 255 / 73%);
    font-size: 12px;
    text-align: center;
    color: white;
    display: flex;
  ...
  `;
    ...
    function createWindow() {
      ...
      titleBar.textContent = "Pang Chat";
    ...
    function openSettingsWindow() {
      ...
      settingsTitleBar.textContent = "Pang Pal Settings";
