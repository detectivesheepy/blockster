...
if (typeof scaffolding == "undefined") {
  (function () {
            ...
            (function (e, t) {
              ...
              try {
                for (i.s(); !(s = i.n()).done; ) {
                  var r = s.value;
                  if (
                    Object.prototype.hasOwnProperty.call(r.nativeDropdowns, e)
                  )
                    ...
                    for (var y = [], v = 0; v < s.length; v++) {
                      ...
                      if (((b.el = b.draw(this)), b.isScript && this.isCommand))
                        ...
                        A && !y.length && u.width < A - n && (u.width = A - n),
                          ...
                          (u.width += 4),
                          b.isLabel ||
                            (u.height = Math.max(u.height, b.height)),
                          u.children.push(b);
                      }
                    }
                    if (
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    (this.width = e.width),
                    (this.height =
                      (e.isBlock && e.firstLine.height) || e.height),
                    ...
                    for (var y, v, b = [], m = 0; m < i.length; m++) {
                      ...
                      if (
                        ...
                        k.isIcon &&
                          ...
                          k.isLabel ||
                            (u.height = Math.max(u.height, k.height)),
                          u.children.push(k),
                          (y = k);
                      }
                    }
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    (this.width = t.width),
                    (this.height =
                      (t.isBlock && t.firstLine.height) || t.height),
    ...
    const icon =
      "data:image/png;base64,";
  ...
  `;
    ...
    function createWindow() {
      ...
      mainWindow.style.maxWidth = screen.width * 0.8 + "px";
      mainWindow.style.maxHeight = screen.height * 0.8 + "px";
    ...
    `;
      ...
      //settingsButton.style.cssText = basicButtonStyle;
    ...
    function openSettingsWindow() {
      ...
      historyLengthInput.value = maxHistoryLength || 10;
      styleSelect.value = selectedStyle || "scratch3";
    }
        ...
        if (
          ...
          while ((match = scratchCodeRegex.exec(responseText)) !== null) {
            ...
            try {
              ...
              processedResponseText = processedResponseText.replace(
                match[0],
                "",
              );
            } catch (e) {
  ...
  console.log("Not loading chatbot noooo no vibe coding!!!!!!");
}
